...
tempcountData <- t(mergedataCB[,(ncol(meta)+2):(ncol(mergedataCB)-(ncol(smplnk)-2) )])
countData <- tempcountData[rowSums(tempcountData)!=0,]
colData <- mergedataCB[,1:(ncol(meta))]
...
countBG = rowSums(mergedataBG[,77:(ncol(mergedataBG)-7)])
countBX = rowSums(mergedataBX[,77:(ncol(mergedataBX)-7)])
countCB = rowSums(mergedataCB[,77:(ncol(mergedataCB)-7)])
