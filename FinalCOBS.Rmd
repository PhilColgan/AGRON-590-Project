...
countBG = rowSums(mergedataBG[,(ncol(meta)+2):(ncol(x)-(ncol(smplnk)-2) )])
countBX = rowSums(mergedataBX[,(ncol(meta)+2):(ncol(x)-(ncol(smplnk)-2) )])
countCB = rowSums(mergedataCB[,(ncol(meta)+2):(ncol(x)-(ncol(smplnk)-2) )])
...
#Figure 1
myvars <- c("BG_act","BX_act","CB_act","Sum_C_act","CB_counts","BX_counts","BG_counts", "agg_frac")
